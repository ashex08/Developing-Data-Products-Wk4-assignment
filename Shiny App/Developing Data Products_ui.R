...
shinyUI(
    navbarPage("Shiny Application",
               ...
               tabPanel("About the Data Set",
                        ...
                        helpText("You work for Motor Trend, a magazine about the automobile industry looking at a
                                 data set of a collection of cars, they are interested in exploring the relationship,
                                 between a set of variables and MPG. They are particularly interested in the following
                                 two questions: Is an automatic or manual transmission better for MPG. Quantify the MPG
               ...
               tabPanel("Go back to my Github repository",
                        a("https://github.com/ashex08/Developing-Data-Products-Wk4-assignment"),
                        hr(),
